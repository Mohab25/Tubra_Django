...
class Drawing(models.Model):
    ...
    aerodrome_category_choices = [('L','Layout'),('P','Profile'),('C','Cross section'),('M','Marking'),('G','General')]
    Drawing_category = models.CharField(max_length=300, null=True,blank=True,default='',choices=aerodrome_category_choices)
