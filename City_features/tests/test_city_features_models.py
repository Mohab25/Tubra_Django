...
class TestCityFeaturesModels(TestCase):
    ...
    def test_city_features_objects_creation(self):
        self.assertTrue(isinstance(self.city_facility,City_Facility))
        self.assertTrue(isinstance(self.city_block,City_Blocks))
        self.assertTrue(isinstance(self.city_street,City_Streets))
        self.assertTrue(isinstance(self.city_district,City_Districts))
