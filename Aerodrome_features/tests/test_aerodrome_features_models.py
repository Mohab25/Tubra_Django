...
class AerodromeFeaturesModelsTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.pavement = Pavement.objects.create(Aerodrome_Entity=cls.aerodrome_entity, Pavement_Name='Test Pavement', Width=45, Shoulder_Width=7.5, Pavement_Design_Type='r',Pavement_geom='MULTIPOLYGON (((30 20, 45 40, 10 40, 30 20)),((15 5, 40 10, 10 20, 5 10, 15 5)))')
    ...
    def test_models_creation(self):
        ...
        self.assertTrue(isinstance(self.pavement,Pavement))
